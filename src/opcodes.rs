...
lazy_static! {
	pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
		...
		OpCode::new(0x02, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0x12, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0x22, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0x32, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0x42, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0x52, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0x62, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0x72, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0x92, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0xB2, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0xD2, JAM, 1, 0, AddressingMode::Implicit),
		OpCode::new(0xF2, JAM, 1, 0, AddressingMode::Implicit),
